        ...
        <div className="productView__content">
          ...
          <form onSubmit={handleSubmit}>
            <div className="productView__size">
              ...
              <label htmlFor="size-s" className={size === "50x70" ? "productView__option productView__option--active" : "productView__option"}>
                50x70
                <input type="radio" name="size" id="size-s" value="50x70" checked={size === "50x70"} onChange={(e) => setSize(e.target.value)} />
              </label>
              <label htmlFor="size-m" className={size === "A3" ? "productView__option productView__option--active" : "productView__option"}>
                A3
                <input type="radio" name="size" id="size-m" value="A3" checked={size === "A3"} onChange={(e) => setSize(e.target.value)} />
              </label>
              <label htmlFor="size-l" className={size === "A2" ? "productView__option productView__option--active" : "productView__option"}>
                A2
                <input type="radio" name="size" id="size-l" value="A2" checked={size === "A2"} onChange={(e) => setSize(e.target.value)} />
              </label>
            </div>
            <div className="productView__frame">
              ...
              <label
                htmlFor="no-frame"
                className={frame === "Ingen ramme" ? "productView__option productView__option--active" : "productView__option"}>
                <p>Ingen</p>
              ...
              <label htmlFor="oak-frame" className={frame === "Eg" ? "productView__option productView__option--active" : "productView__option"}>
                ...
                <input type="radio" name="frame" id="oak-frame" value="Eg" checked={frame === "Eg"} onChange={(e) => setFrame(e.target.value)} />
              </label>
