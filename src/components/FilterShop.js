...
export default function FilterShop({ open, setFiltered, products, category, setCategory, priceLimit, setPriceLimit }) {
  useEffect(() => {
    ...
    <aside className={open ? "shopFilter shopFilter--open" : "shopFilter"}>
      <div className="shopFilter__content">
        ...
        <div className="shopFilter__filter">
          ...
          <button
            className={`shopFilter__button${
              category === undefined ? " shopFilter__button--active" : ""
            }`}
            onClick={() => setCategory()}
          >
            alle
          ...
          <button
            className={`shopFilter__button${
              category === "Udvalgte" ? " shopFilter__button--active" : ""
            }`}
          ...
          <button
            className={`shopFilter__button${
              category === "Nyheder" ? " shopFilter__button--active" : ""
            }`}
          ...
          <button
            className={`shopFilter__button${
              category === "Vinter" ? " shopFilter__button--active" : ""
            }`}
          ...
          <button
            className={`shopFilter__button${
              category === "Sommer" ? " shopFilter__button--active" : ""
            }`}
        ...
        <div className="shopFilter__filter">
          ...
          <button
            className={`shopFilter__button${
              priceLimit === undefined ? " shopFilter__button--active" : ""
            }`}
          ...
          <button
            className={`shopFilter__button${
              priceLimit === 200 ? " shopFilter__button--active" : ""
            }`}
          ...
          <button
            className={`shopFilter__button${
              priceLimit === 300 ? " shopFilter__button--active" : ""
            }`}
          ...
          <button
            className={`shopFilter__button${
              priceLimit === 400 ? " shopFilter__button--active" : ""
            }`}
          ...
          <button
            className={`shopFilter__button${
              priceLimit === 500 ? " shopFilter__button--active" : ""
            }`}
